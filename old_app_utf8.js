...
function resetResumeFormToDefault(draftId) {
    ...
    document.getElementById("res-edu1-dates").value = "2024 ΓÇô 2028";
    ...
    document.getElementById("res-edu2-dates").value = "2020 ΓÇô 2024";
    ...
    document.getElementById("res-exp-dates").value = "June 2025 ΓÇô August 2025";
    ...
    document.getElementById("res-proj-title").value = "AegisShield AI ΓÇô Cyber Crime Detection Platform";
