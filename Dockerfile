...
RUN apt-get update && apt-get install -y libcairo2 libpango-1.0-0 libpangoft2-1.0-0 libjpeg-dev libopenjp2-7-dev libffi-dev shared-mime-info && rm -rf /var/lib/apt/lists/*
